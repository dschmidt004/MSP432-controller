...
int main(void)
{
    ...
    MAP_GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P5, GPIO_PIN0|GPIO_PIN1|GPIO_PIN3);
    MAP_GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P3, GPIO_PIN5);
    MAP_GPIO_clearInterruptFlag(GPIO_PORT_P5, GPIO_PIN0|GPIO_PIN1|GPIO_PIN3);
    MAP_GPIO_enableInterrupt(GPIO_PORT_P5, GPIO_PIN0|GPIO_PIN1|GPIO_PIN3);
    MAP_Interrupt_enableInterrupt(INT_PORT5);
    MAP_GPIO_enableInterrupt(GPIO_PORT_P3, GPIO_PIN0|GPIO_PIN1|GPIO_PIN3);
 ...
 if (ADC_INT0 & status)
  {
     ...
     float temperatureC = (normalizedADCRes - 0.5)*90;
     float tempF = (((temperatureC*9)/5) +32);


     printFloat(GPIO_PIN0);
     printFloat(GPIO_PIN1);
     printFloat(GPIO_PIN2);
     printFloat(GPIO_PIN5);
     transmit("\n\r");
